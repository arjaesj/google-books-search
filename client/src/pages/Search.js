  ...
  render() {
    return (
      ...
      <Col size="md-6">
            <div>
            <form>
                Type your Book Search keyword below (Title or Author):
              <Input
                value={this.state.search}
                onChange={this.handleInputChange}
                name="search"
                placeholder="eg. Lord of the Rings or Tolkien "
              />
              <FormBtn
            ...
            <Col size="md-12">
              {!this.state.books.length ? (
                <h1 id="message" className="text-center">Matching searched books displayed here.</h1> 
              ) : (
                <div>
